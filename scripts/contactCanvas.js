var contact_canvas = $('#contact_canvas')[0];
context = contact_canvas .getContext('2d');
var x = 45;
var y = -3;
...
$('#pnav_contact').mousemove(function (e) {

    if (e.which == 1) {
        x = 40 + $('#win_contact')[0].getBoundingClientRect().left / 15;
        y = 3 - $('#win_contact')[0].getBoundingClientRect().top / 20;
        drawInPosition();
